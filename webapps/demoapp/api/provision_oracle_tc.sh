...
# ./provision_oracle_i.sh orcl VBITT "Oracle_Target" "Linux Host" "/u01/app/oracle/product/11.2.0.4/db_1" "/mnt/provision" "200M" "false"
#
#########################################################
#                   DELPHIX CORP                        #
...
if [ "${RESULTS}" != "OK" ]
then
   echo "Error: Invalid Session or Login, Exiting ..."
   #exit 1;
fi
