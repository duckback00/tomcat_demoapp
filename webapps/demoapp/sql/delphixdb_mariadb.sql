...
INSERT INTO `employees` (`EMPLOYEE_ID`, `FIRST_NAME`, `LAST_NAME`, `DEPT_NAME`, `CITY`) VALUES
(1,'Woody', 'Evans', 'Solution Architects', 'Hoboken'),
(2,'Jeff', 'Zeisler', 'Solution Architects', 'Menlo Park'),
(3,'Dr. Jeff', 'Wootton', 'Lyrical Rap Studies', 'Reston'),
(4,'Dino', 'Konstantinos', 'Sales', 'Fantasyland'),
(5,'Ted', 'Girard', 'Sales', 'Bethesda'),
(6,'Adam', 'Bowen', 'No Sleep Till', 'Brooklyn'),
(7,'Adam', 'Bowen', 'Solution Architects', 'Ashland'),
(8,'Luther', 'Vandross', 'Superstar', 'NYC'),
(9,'Ted', 'Girard', 'Sales', 'Bethesda'),
(10,'Jude', 'Seth', 'Solution Architects', 'DK');
...
GRANT ALL PRIVILEGES ON *.* TO 'delphixdb'@'localhost';
GRANT ALL PRIVILEGES ON *.* TO 'delphixdb'@'%';
