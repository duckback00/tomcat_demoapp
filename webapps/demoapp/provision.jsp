...
if (request.getParameter("submit") != null) {
  ...
  session.setAttribute("configTemplate",request.getParameter("configTemplate"));
  session.setAttribute("archiveLog",request.getParameter("archiveLog"));
...
function CloseMySelf(sender) {
    ...
    try {
        ...
        window.opener.HandlePopupResult(sender.elements["vname"].value,sender.elements["mntPath"].value,sender.elements["dpxGrp"].value,sender.elements["envNm"].value,sender.elements["envInst"].value,sender.elements["configTemplate"].value,sender.elements["archiveLog"].value);
    }
    catch (err) {}
    ////window.close();
    ////return false;
...
<tr>
<td rowspan=2 style="padding-top:15px;padding-left:4px;">
...
<font size=+1><b>Provisioning VDBs</b></font>
</td>
</tr>
</table>
...
<tr>
<td align=right width="40%">VDB Config Template: </td><td><input "type=text" name="configTemplate" value="<%= session.getAttribute("configTemplate") %>" size=54 /></td>
</tr>

<tr>
<td align=right width="40%">Archive Log Mode: </td><td><input "type=text" name="archiveLog" value="<%= session.getAttribute("archiveLog") %>" size=54 /></td>
</tr>
...
<tr> <td align=right>Target Environment Instance: </td><td>/u01/app/oracle/product/11.2.0.4/db_1</td><td>MSSQLSERVER</td></tr>
<tr><td align=right>VDB Config Template Name: </td><td>200M</td><td></td></tr>
<tr><td align=right>Archive Log Mode: </td><td>false</td><td></td></tr>
</table>
